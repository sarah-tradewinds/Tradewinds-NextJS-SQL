...
function Banner() {
	...
	return (
		<div className="  w-[300px]s h-[207px] w-full justify-center bg-[url('/static/images/WhyBuyImages/why-buy-header-phone.png')] bg-cover bg-no-repeat sm:h-[343px] sm:bg-[url('/static/images/WhyBuyImages/why-buy-header.png')] md:h-[343px] lg:h-[458px] desktop:h-[703px] ">
