	...
	return (
		<div>
			...
			<div className=" container left-1/2 z-50  mx-auto block h-[308px] w-[300px] justify-center space-y-[20px] rounded-[0px] bg-primary-eco  pr-[19px] pt-[13px] pl-[16px] text-left text-[12px] leading-[14px] text-beauty sm:block sm:h-[170px] sm:w-[566px]  sm:space-y-[15px] sm:rounded-[12px] sm:pr-[22px] sm:pt-[10px] sm:pl-[15px] sm:text-center sm:text-[12px] sm:leading-[15px] md:hidden lg:hidden desktop:hidden ">
				<p>
					Welcome to Tradewinds Marketplace, your ultimate destination
					for global trade success. We understand the importance of
					expanding your business beyond borders and reaching customers
					around the world. With our innovative platform, we provide a
					dynamic marketplace where sellers can thrive, and buyers can
			...
			<div className="container mx-auto mt-[22px] mb-[31px]  sm:mb-[44px] sm:mt-[23px] md:mt-[35px] md:mb-[40px] lg:mt-[53px] lg:mb-[42px] desktop:mt-[79px] desktop:mb-[81px]">
				...
				<p className=" mx-auto mt-[0px] h-[76px] w-[265px] text-center text-[12px] leading-[15px] text-gray sm:mt-[6px] sm:h-[34px] sm:w-[564px] sm:text-[12px] sm:leading-[15px] md:mt-[7px] md:h-[40px] md:w-[602px] md:text-[12px] md:leading-[14px] lg:mt-[10px] lg:h-[59px] lg:w-[907px] lg:text-[18px] lg:leading-[21px] desktop:mt-[15px] desktop:h-[81px] desktop:w-[1241px] desktop:text-[25px] desktop:leading-[30px] ">
				...
				<div className=" container mx-auto ml-[67px] mt-[14px] block justify-center space-x-0 sm:!ml-0 sm:mt-[34px] sm:!flex sm:space-x-[45px] md:mt-[20px] md:space-x-[52px] lg:mt-[30px] lg:space-x-[106px] desktop:mt-[51px] desktop:space-x-[100px]">
					<div className=" flex space-x-[7px] sm:space-x-[7px] md:space-x-[9px] lg:space-x-[20px] desktop:space-x-[20px]">
						...
						<div className=" h-[112px] w-[142px] space-y-[16px] sm:h-[112px] sm:w-[142px] sm:space-y-[16px] md:h-[126px] md:w-[161px] md:space-y-[20px] lg:h-[168px] lg:w-[214px] lg:space-y-[22px] desktop:h-[302px] desktop:w-[374px] desktop:space-y-[40px]">
							<WhyBuyOperationTailContent content="Organic" />
							<WhyBuyOperationTailContent content="Biodegradable" />
							<WhyBuyOperationTailContent content="Nontoxic" />
							<WhyBuyOperationTailContent content="Sustainably sourced" />
						</div>
					</div>
					<div className="mt-[14px] flex space-x-[7px] sm:!mt-0 sm:space-x-[7px] md:space-x-[9px] lg:space-x-[20px] desktop:space-x-[20px]">
						...
						<div className="h-[112px] w-[152px] space-y-[16px] sm:h-[112px] sm:w-[152px] sm:space-y-[16px] md:h-[126px] md:w-[168px] md:space-y-[20px] lg:h-[144px] lg:w-[223px] lg:space-y-[22px] desktop:h-[258px] desktop:w-[390px] desktop:space-y-[40px]">
							<WhyBuyOperationTailContent content="Cruelty-free" />
							<WhyBuyOperationTailContent content="Renewable" />
							<WhyBuyOperationTailContent content="Ethically and sustainably produced" />
						</div>
					</div>
				</div>
