...
const CardB: React.FC<CardBProps> = (props) => {
	...
	return (
		<Link
			href={href}
			className="block h-[153px] w-[203px] overflow-hidden rounded-md bg-gradient-to-r from-[#E7CA00] to-[#E8A30E] transition-all hover:-translate-y-[2px] sm:h-[203px] sm:w-[245px] lg:h-[244.24px] lg:w-[325.92px] xl:h-[305px] xl:w-[405.73px] desktop:h-[352px] desktop:w-[466px]"
		>
			<h2 className="ml-[14px] mt-[5.5px] text-[18px] font-semibold leading-[21.94px] text-gray dark:text-gray sm:pt-[4px] lg:text-[21px] lg:leading-[25.6px] xl:ml-[29.85px] xl:text-[25px] xl:leading-[30.48px] desktop:ml-[34px]">
				{title}
			</h2>
