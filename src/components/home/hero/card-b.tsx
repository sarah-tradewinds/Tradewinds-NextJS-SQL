	...
	return (
		<div className="flex flex-1 flex-col justify-between gap-3  rounded-md bg-secondary p-3 transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg sm:gap-0 md:h-[240px] md:w-[300px] lg:h-[356px] lg:w-[380px] lg:p-6 xl:w-[416px] pc:h-[300px]">
			...
			<div className="flex flex-row">
				...
				<div className="flex flex-col gap-4 pl-2 lg:pl-4 pc:pl-0">
					...
					<Button
						href={href}
						variant="buyer"
						className="whitespace-nowrap font-[12px] shadow-lg transition-colors duration-300 ease-in-out hover:bg-accent-secondary-main/70 lg:font-[16px]"
					>
			...
			<p className="font-mont text-base text-gray pc:hidden">
				<span className="text-home font-mont font-[18px] font-bold dark:text-accent-secondary-eco md:break-all">
					{name}
				</span>
				&nbsp; {description}
			</p>
