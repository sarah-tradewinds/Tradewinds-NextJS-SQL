...
const CardA: React.FC<CardAProps> = (props) => {
	...
	return (
      ...
      lg:mx-[21px] lg:mt-[14px] lg:pt-[3px] lg:text-[25px] lg:leading-[30px]"
			...
			<div className="lg:mx-[23px]s relative mt-1 h-[86px] w-[180px] overflow-hidden md:ml-[11.14px] md:mr-[11.45px] md:mt-[3.19px] md:block md:h-[109.63px] md:w-[203.41px] lg:mt-[15px] lg:h-[201px] lg:w-[420px]">
