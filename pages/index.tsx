...
const HomePage: NextPage<InferGetStaticPropsType<GetStaticProps>> = (
	...
	const searchCategoriesAndTrendingBanner = (
		...
		<div className="grid gap-4 md:grid-cols-2 lg:!grid-cols-1 2xl:!grid-cols-2 desktop:grid-cols-1">
			...
			{/* Trending section */}
			<div className="hidden items-center justify-end bg-[url('/latest-trend-image.png')] bg-left p-3 md:flex lg:hidden 2xl:!flex">
