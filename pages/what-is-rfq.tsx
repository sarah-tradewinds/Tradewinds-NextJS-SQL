					...
					<div className="space-y-4">
						...
						<div className="text-gray lg:text-white">
							<h4 className="text-[12px] font-semibold md:text-[16px] lg:text-[18px]">
								...
								responses. As a rule, it makes sense to make your vendor
								pool small enough, so it’s manageable for you.
							</h4>
							<p className="text-[12px] md:text-[16px] lg:text-[15px]">
						...
						<p className="text-[12px] text-gray md:text-[16px] lg:text-[15px] lg:text-white">
							By the end of the deadline, you can then review responses
							to identify what vendors present the best prices that
						</p>
						<p className="text-[12px] text-gray md:text-[16px] lg:text-[15px] lg:text-white">
							Choose your preferred quote: Your decision will likely be
							the vendor that presents the best price. But this may not
							always be the case. You may decide to select a
						...
						<p className="text-[12px] text-gray md:text-[16px] lg:text-[15px] lg:text-white">
							...
							decision and how you intend to proceed. Be certain to keep
							a copy of the RFQ as it will form the basis of your
					...
					<div className="space-y-4">
						...
						<div className="text-gray lg:text-white">
							...
							<p className="text-[12px] md:text-[16px] lg:text-[15px]">
								...
								until it is formally agreed upon by both parties. Also,
								notify other vendors who sent in quotations of your
								decision to go with another vendor.
							</p>
						</div>
					</div>
				</div>
