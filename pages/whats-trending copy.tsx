...
> = (props) => {
	...
	return (
		<div className="md:container">
			...
			{/* Banner image */}
			<div className="relative h-[241px] w-full bg-error">
				...
				<p className="absolute bottom-[26px] right-5 w-[117px] text-[25px] font-semibold leading-[30.48px] text-white">
					What’s Trending
				</p>
			</div>
			...
			<div className=" md:hidden">
				...
				<div className="h-[99px] bg-primary-main">
					{/* action */}
					<div
				...
				<div className="h-[61px] rounded-md bg-white">
					<div className="h-[23.66px] w-[26.5px] text-[19.48px] font-semibold leading-[23.75px]">
						1
					</div>
					<p className="w-[15px] font-semibold leading-[18.29px] text-gray">
						Energy
					</p>
					<div>
			...
			<div className="relative hidden md:mt-[9px] md:mr-[10px] md:flex md:pl-[9px] lg:mt-[19px] lg:flex lg:pl-6">
				...
				<div className="hidden md:w-[727px] lg:w-[1142px]">
					<div>
						<Tab.Group>
